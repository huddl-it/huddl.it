    ...
    return (
        <Layout>
            <div className="flex flex-col gap-6">
                ...
                <div className="bg-white/70 backdrop-blur-xl px-12 py-8 rounded-xl max-w-3xl cursor-pointer">
                    <h2 className="text-xl font-bold mb-2 hover:underline">
                        How to be cool like Jaideep Guntupalli?
                    </h2>
                    <p>
                        I have seen Jaideep Guntupalli in and around the campus. I
                        want to be smart and intelligent as him. I also want to learn his business strategy and become a successful businessman like him.
                        Please someone give tips to become such a pro-coder like Guntupalli sir.
                ...
                <div className="bg-white/70 backdrop-blur-xl px-12 py-8 rounded-xl max-w-3xl cursor-pointer">
                    <h2 className="text-xl font-bold mb-2 hover:underline">
                        How to be cool like Thushar Narayan?
                    </h2>
                    <p>
                        I have seen Thushar Narayan in and around the campus. I
                        want to be smart and intelligent as him. I also want to learn his business strategy and become a successful businessman like him.
                        Please someone give tips to become such a pro-coder like Guntupalli sir.
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo
                        sint saepe ut tenetur adipisci ipsam officiis, deserunt
